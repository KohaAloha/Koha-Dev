...
-->
 ...
 <identifier>
 <xsl:call-template name="isInvalid"/>
 <xsl:attribute name="type"><xsl:choose><xsl:when test="@ind1=0">numéro de fascicule</xsl:when><xsl:when test="@ind1=1">Numéro matriciel</xsl:when><xsl:when test="@ind1=2">disque musical</xsl:when><xsl:when test="@ind1=3">éditeur de musique</xsl:when><xsl:when test="@ind1=4">identifiant enregistrement vidéo</xsl:when></xsl:choose></xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 ...
 <xsl:attribute name="script"><xsl:choose><xsl:when test="$scriptCode='(3'">Arabe</xsl:when><xsl:when test="$scriptCode='(B'">Latin</xsl:when><xsl:when test="$scriptCode='$1'">Chinois, japons, koréen</xsl:when><xsl:when test="$scriptCode='(N'">Cyrillique</xsl:when><xsl:when test="$scriptCode='(2'">Hébreu</xsl:when><xsl:when test="$scriptCode='(S'">Grec</xsl:when></xsl:choose></xsl:attribute>
 </xsl:template>
 ...
 <language>
 <xsl:if test="@code!='a'">
 <xsl:attribute name="objectPart"><xsl:choose><xsl:when test="@code='b'">résumé ou sous-titre</xsl:when><xsl:when test="@code='d'">Chanson ou texte dit</xsl:when><xsl:when test="@code='e'">libretto</xsl:when><xsl:when test="@code='f'">Table des matières</xsl:when><xsl:when test="@code='g'">matériel d'accompagnement</xsl:when><xsl:when test="@code='h'">traduction</xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
