...
<xsl:stylesheet version="1.0"
 ...
 <span class="results_summary"><span class="label">Collections&nbsp;: </span>
 ...
 AvlÃ¸ser delvis: </xsl:when>
 <xsl:when test="@ind2=4">
 SammenslÃ¥ing av: ... ; og ... </xsl:when>
 ...
 AvlÃ¸st av: </xsl:when>
 <xsl:when test="@ind2=3">
 Delvsi avlÃ¸st av: </xsl:when>
 <xsl:when test="@ind2=4">
 GÃ¥tt inn i: </xsl:when>
 <xsl:when test="@ind2=5">
 Delvis gÃ¥tt inn i: </xsl:when>
 <xsl:when test="@ind2=6">
 Fortsettes av: ...; og ... </xsl:when>
 <xsl:when test="@ind2=7">
 SlÃ¥tt sammen med: .., til: ... </xsl:when>
 </xsl:choose>
 </span>
