...
<xsl:stylesheet version="1.0"
 ...
 <xsl:choose>
 <xsl:when test="$typeOf008='Mon'"><img alt="Livre" src="/intranet-tmpl/prog/img/famfamfam/BK.png" title="Livre" /> Livre</xsl:when>
 ...
 <xsl:when test="contains($controlField008-24,'b')"> Bibliographies</xsl:when>
