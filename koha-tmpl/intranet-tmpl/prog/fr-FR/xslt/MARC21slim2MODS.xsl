...
<xsl:stylesheet version="1.0" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns="http://www.loc.gov/mods/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
 ...
 <xsl:when test="$leader6='i' or $leader6='j'">enregistrement sonore</xsl:when>
 ...
 <targetAudience>adulte</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience>général</targetAudience>
 </xsl:when>
 ...
 <targetAudience>spécialisé</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
...
-->
 ...
 <xsl:otherwise>relatif à</xsl:otherwise>
 </xsl:choose>
 </xsl:attribute>
 </xsl:template>
