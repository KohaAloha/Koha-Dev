...
-->
 ...
 <role>
 <roleTerm authority="marcrelator" type="text">créateur</roleTerm>
 </role>
 ...
 <xsl:choose>
 <xsl:when test="$leader6='a' or $leader6='t'">texte</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">cartographie</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">musique annotée</xsl:when>
 <xsl:when test="$leader6='i'">enregistrement non musical</xsl:when>
 <xsl:when test="$leader6='j'">enregistrement sonore</xsl:when>
 <xsl:when test="$leader6='k'">image fixe</xsl:when>
 <xsl:when test="$leader6='g'">image animée</xsl:when>
 <xsl:when test="$leader6='r'">Objet tri-dimensionnel</xsl:when>
 <xsl:when test="$leader6='m'">logiciel, multimedia</xsl:when>
 <xsl:when test="$leader6='p'">matériaux composites</xsl:when>
 </xsl:choose>
 </typeOfResource>
 ...
 <genre authority="marc">Image de télédétection</genre>
 </xsl:if>
 ...
 <genre authority="marc">carte</genre>
 </xsl:when>
 ...
 <genre authority="marc">base de données</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">feuille morte</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">Collections</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">journal</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='p'">
 <genre authority="marc">periodical</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='w'">
 <genre authority="marc">site web</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">résumé ou sommaire</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">bibliographie</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">catalogue</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">Dictionnaire</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'e')">
 <genre authority="marc">encyclopedia</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'f')">
 <genre authority="marc">livre de poche</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'g')">
 <genre authority="marc">articles juridiques</genre>
 </xsl:when>
 ...
 <genre authority="marc">législation</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">Thèses</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 <genre authority="marc">survey of literature</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'o')">
 <genre authority="marc">commentaire</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'p')">
 <genre authority="marc">programmed text</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'q')">
 <genre authority="marc">filmographie</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'r')">
 <genre authority="marc">répertoire</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'s')">
 <genre authority="marc">statistiques</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">rapport technique</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'v')">
 <genre authority="marc">cas de droit et notes de cas</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'w')">
 <genre authority="marc">rapports de lois et recueils</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'z')">
 <genre authority="marc">Traité</genre>
 </xsl:when>
 </xsl:choose>
 <xsl:variable name="controlField008-29" select="substring($controlField008,30,1)"></xsl:variable>
 <xsl:choose>
 <xsl:when test="$controlField008-29='1'">
 <genre authority="marc">Conférence</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">donnée numérique</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">base de données</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">police</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">jeu</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">biographie</genre>
 </xsl:if>
 <xsl:variable name="controlField008-33" select="substring($controlField008,34,1)"></xsl:variable>
 <xsl:choose>
 <xsl:when test="$controlField008-33='e'">
 <genre authority="marc">essai</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">drama</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">bande dessinée</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">fiction</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='h'">
 <genre authority="marc">humour, satire</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">lettre</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">roman</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='j'">
 <genre authority="marc">nouvelle</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">discours</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">conte populaire</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'h')">
 <genre authority="marc">Historique</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'k')">
 <genre authority="marc">humour, satire</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'m')">
 <genre authority="marc">mémoires</genre>
 </xsl:if>
 ...
 <genre authority="marc">rapports</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'s')">
 <genre authority="marc">son</genre>
 </xsl:if>
 ...
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">film fixe en bande</genre>
 </xsl:when>
 ...
 <genre authority="marc">graphique</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">dessin technique</genre>
 </xsl:when>
 ...
 <genre authority="marc">carte flash</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='p'">
 <genre authority="marc">diapositives microscopes</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='q' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='q']">
 <genre authority="marc">modèle</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='r'">
 <genre authority="marc">realia</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">diapositive</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='t'">
 <genre authority="marc">transparent</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='v'">
 <genre authority="marc">enregistrement vidéo</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='w'">
 <genre authority="marc">jouet</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:attribute name="authority">pays marc</xsl:attribute>
 ...
 <issuance>
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">monographie</xsl:when>
 <xsl:when test="$leader7='b' or $leader7='i' or $leader7='s'">continue</xsl:when>
 </xsl:choose>
 </issuance>
 </xsl:for-each>
 ...
 <digitalOrigin>Numérique reformaté</digitalOrigin>
 </xsl:if>
 <xsl:if test="$typeOf008='CF' and marc:controlfield[@tag=007][substring(.,12,1)='b']">
 <digitalOrigin>microfilm</digitalOrigin>
 </xsl:if>
 ...
 <reformattingQuality>remplacement</reformattingQuality>
 </xsl:when>
 </xsl:choose>
 </xsl:for-each>
 <!--3.2 change tmee 007/01 -->
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='b']">
 <form authority="smd">fim fixe en cartouche</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='c']">
 <form authority="smd">disque optique informatique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='j']">
 <form authority="smd">disque magnétique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='m']">
 <form authority="smd">disque magnéto-optique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='o']">
 <form authority="smd">disque optique</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='r']">
 <form authority="smd">distant</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='a']">
 <form authority="smd">bande (cartouche)</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='f']">
 <form authority="smd">cassette audio</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='c'][substring(text(),2,1)='h']">
 <form authority="smd">bande (sur bobine)</form>
 </xsl:if>
 
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='d'][substring(text(),2,1)='a']">
 <form authority="smd">globe céleste</form>
 </xsl:if>
 ...
 <form authority="smd">globe terrestre</form>
 </xsl:if>
 ...
 <form authority="smd">diagramme</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='j']">
 <form authority="smd">carte</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='q']">
 <form authority="smd">modèle</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='k']">
 <form authority="smd">profile</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='r']">
 <form authority="smd">Image de télédétection</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='s']">
 <form authority="smd">section</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='y']">
 <form authority="smd">Voir</form>
 </xsl:if>
 ...
 <form authority="smd">cassette microfiche</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='h'][substring(text(),2,1)='b']">
 <form authority="smd">cartouche microforme</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='h'][substring(text(),2,1)='c']">
 <form authority="smd">cassette microfiche</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='h'][substring(text(),2,1)='d']">
 <form authority="smd">microfilm</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='h'][substring(text(),2,1)='g']">
 <form authority="smd">micro opaque</form>
 </xsl:if>
 ...
 <form authority="smd">Bande VHS / Videocassette</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='m'][substring(text(),2,1)='r']">
 <form authority="smd">bobine de film</form>
 </xsl:if>
 ...
 <form authority="smd">carte flash</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='k'][substring(text(),2,1)='e']">
 <form authority="smd">peinture</form>
 </xsl:if>
 ...
 <form authority="smd">dessin technique</form>
 </xsl:if>
 
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='q'][substring(text(),2,1)='q']">
 <form authority="smd">musique annotée</form>
 </xsl:if>
 
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='d']">
 <form authority="smd">film fixe en bande</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='c']">
 <form authority="smd">film fixe en cartouche</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='o']">
 <form authority="smd">film fixe en rouleau</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='f']">
 <form authority="smd">autre type de bobine de film</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='s']">
 <form authority="smd">diapositive</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='g'][substring(text(),2,1)='t']">
 <form authority="smd">transparent</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='r'][substring(text(),2,1)='r']">
 <form authority="smd">Image de télédétection</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='e']">
 <form authority="smd">cylindre</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='q']">
 <form authority="smd">rouleau</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='g']">
 <form authority="smd">cartouche audio</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='s']">
 <form authority="smd">cassette audio</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='d']">
 <form authority="smd">enregistrement musical</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='t']">
 <form authority="smd">bande (sur bobine)</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='i']">
 <form authority="smd">piste sonore</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='s'][substring(text(),2,1)='w']">
 <form authority="smd">enregistrement sur fil</form>
 </xsl:if>
 ...
 <form authority="smd">combinaison de données</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='f'][substring(text(),2,1)='a']">
 <form authority="smd">lune</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='f'][substring(text(),2,1)='d']">
 <form authority="smd">tactile, sans système d'écriture</form>
 </xsl:if>
 ...
 <form authority="smd">Gros caractères</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='t'][substring(text(),2,1)='a']">
 <form authority="smd">Impression normale</form>
 </xsl:if>
 ...
 <form authority="smd">cartouche vidéo</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='v'][substring(text(),2,1)='f']">
 <form authority="smd">vidéocassette</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='v'][substring(text(),2,1)='d']">
 <form authority="smd">vidéodisque</form>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='v'][substring(text(),2,1)='r']">
 <form authority="smd">bobine vidéo</form>
 </xsl:if>
 ...
 <targetAudience authority="marctarget">adulte</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience authority="marctarget">général</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience authority="marctarget">jeunesse</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience authority="marctarget">preschool</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience authority="marctarget">spécialisé</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:attribute name="type">
 <xsl:choose>
 <xsl:when test="@ind1='0'">numéro de fascicule</xsl:when>
 <xsl:when test="@ind1='1'">Numéro matriciel</xsl:when>
 <xsl:when test="@ind1='2'">disque musical</xsl:when>
 <xsl:when test="@ind1='3'">éditeur de musique</xsl:when>
 <xsl:when test="@ind1='4'">identifiant enregistrement vidéo</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 ...
 <xsl:choose>
 <xsl:when test="$scriptCode='(3'">Arabe</xsl:when>
 <xsl:when test="$scriptCode='(B'">Latin</xsl:when>
 <xsl:when test="$scriptCode='$1'">Chinois, japons, koréen</xsl:when>
 <xsl:when test="$scriptCode='(N'">Cyrillique</xsl:when>
 <xsl:when test="$scriptCode='(2'">Hébreu</xsl:when>
 <xsl:when test="$scriptCode='(S'">Grec</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 </xsl:template>
 ...
 <xsl:choose>
 <xsl:when test="@code='b'">résumé ou sous-titre</xsl:when>
 <xsl:when test="@code='d'">Chanson ou texte dit</xsl:when>
 <xsl:when test="@code='e'">libretto</xsl:when>
 <xsl:when test="@code='f'">Table des matières</xsl:when>
 <xsl:when test="@code='g'">matériel d'accompagnement</xsl:when>
 <xsl:when test="@code='h'">traduction</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
