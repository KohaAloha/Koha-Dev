...
<xsl:stylesheet version="1.0"
 ...
 <xsl:when test="$field019b='f' or $field019b='i' or contains($field019b,'ib') or contains($field019b,'ic') or contains($field019b,'fd') or contains($field019b,'ff') or contains($field019b,'fi') or $leader6='k'">diagramme</xsl:when>
 ...
 <xsl:if test="contains($field019b,'aj')"> Panier</xsl:if>
 ...
 <xsl:if test="contains($field019b,'db')"> Cassette film</xsl:if>
 <xsl:if test="contains($field019b,'dc')"> Kompaktplate</xsl:if>
 <xsl:if test="contains($field019b,'dd')"> Avspiller med lydfil (eks. DigibÃ¸ker)</xsl:if>
 <xsl:if test="contains($field019b,'dg')"> Musique</xsl:if>
 ...
 <xsl:if test="$field019b='e'"> Filmographies</xsl:if>
 <xsl:if test="contains($field019b,'ec')"> filmstrip roll</xsl:if>
 <xsl:if test="contains($field019b,'ed')"> Vidéocassette</xsl:if>
 <xsl:if test="contains($field019b,'ee')"> Videoplate (DVD)</xsl:if>
 <xsl:if test="contains($field019b,'ef')"> Blu-ray-plate</xsl:if>
 <xsl:if test="$field019b='f'"> Matériel visuel</xsl:if>
 <xsl:if test="contains($field019b,'fd')"> Dias</xsl:if>
 <xsl:if test="contains($field019b,'ff')"> Fotografi</xsl:if>
 <xsl:if test="contains($field019b,'fi')"> Reproduction d'art</xsl:if>
 ...
 <xsl:if test="contains($field019b,'ib')"> microfilm</xsl:if>
 <xsl:if test="contains($field019b,'ic')"> microfilm</xsl:if>
 <xsl:if test="$field019b='j'"> Périodique</xsl:if>
 <xsl:if test="$field019b='k'"> Artikler (i bÃ¸ker eller periodika)</xsl:if>
 <xsl:if test="$field019b='l'"> Fysiske bÃ¸ker</xsl:if>
 </xsl:if>
 ...
 <xsl:if test="$controlField007-01='e'">SjÃ¸kart</xsl:if>
 ...
 <xsl:if test="$controlField007-01='j'">Panier</xsl:if>
 ...
 <xsl:if test="$controlField007-01='r'">RÃ¸ntgenbilde</xsl:if>
 ...
 <xsl:if test="$controlField007-01='c'">cassette microfilm</xsl:if>
 <xsl:if test="$controlField007-01='d'">microfilm</xsl:if>
 <xsl:if test="$controlField007-01='e'">microfilm</xsl:if>
 ...
 <xsl:if test="$controlField007-01='e'">Masculin</xsl:if> <!-- Originalt kunstverk -->
 <xsl:if test="$controlField007-01='g'">Négatif photo</xsl:if>
 ...
 <xsl:if test="$controlField007-01='n'">Plans</xsl:if>
 ...
 <xsl:if test="$controlField007-01='r'">Reproduction d'art</xsl:if>
 ...
 <!-- Film -->
 <xsl:if test="$controlField007-01='c'">filmstrip roll</xsl:if>
 <xsl:if test="$controlField007-01='f'">Cassette film</xsl:if>
 <xsl:if test="$controlField007-01='r'">filmstrip roll</xsl:if>
 ...
 <xsl:if test="$controlField007-01='e'">cylindre </xsl:if> <!-- Lydrull, voksrull, fonografsylinder -->
 <xsl:if test="$controlField007-01='g'">SlÃ¸yfekassett</xsl:if>
 ...
 <xsl:if test="$controlField007-01='c'">Reproduction d'art</xsl:if>
 <xsl:if test="$controlField007-01='d'">Diorama</xsl:if>
 <xsl:if test="$controlField007-01='e'">Ãvelsesmodell</xsl:if>
 <xsl:if test="$controlField007-01='g'">Spill</xsl:if>
 <xsl:if test="$controlField007-01='p'">Mikroskopdia</xsl:if>
 <xsl:if test="$controlField007-01='q'">modèle</xsl:if>
 ...
 <xsl:if test="$controlField007-01='f'">Vidéocassette</xsl:if>
 ...
 <span class="results_summary analytics"><span class="label">Analytique :</span>
 <a>
 <xsl:choose>
 ...
 <xsl:text>Montrer les dépouillements</xsl:text>
 </a>
 </span>
 </xsl:if>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:when test="$typeOf008='Per'"><img alt="Périodique" src="/opac-tmpl/lib/famfamfam/AR.png" title="Périodique" /> Périodique</xsl:when>
 <xsl:when test="$typeOf008='Fil'"><img src="/opac-tmpl/lib/famfamfam/CF.png" alt="Fil" title="Fil"/> Fil</xsl:when>
 <xsl:when test="$typeOf008='Kar'"><img alt="Panier" src="/opac-tmpl/lib/famfamfam/MP.png" title="Panier" /> Panier</xsl:when>
 <xsl:when test="$typeOf008='FV'"><img alt="Filmographies" src="/opac-tmpl/lib/famfamfam/VM.png" title="Filmographies" /> Filmographies</xsl:when>
 <xsl:when test="$typeOf008='Mus'"><img src="/opac-tmpl/lib/famfamfam/PR.png" alt="Musikktrykk og lydopptak" title="Musikktrykk og lydopptak"/> Musique</xsl:when>
 <xsl:when test="$typeOf008='gra'"><img alt="Matériel visuel" src="/opac-tmpl/lib/famfamfam/GR.png" title="Matériel visuel" /> Matériel visuel</xsl:when>
 ...
 <xsl:when test="contains($controlField008-24,'d')"> OrdbÃ¸ker</xsl:when>
 <xsl:when test="contains($controlField008-24,'e')"> Konversasjonsleksika</xsl:when>
 <xsl:when test="contains($controlField008-24,'f')"> HÃ¥ndbÃ¸ker</xsl:when>
 ...
 <xsl:when test="contains($controlField008-24,'k')"> Discographies</xsl:when>
 ...
 <xsl:when test="contains($controlField008-24,'q')"> Filmographies</xsl:when>
 <xsl:when test="contains($controlField008-24,'r')"> AdressebÃ¸ker</xsl:when>
 <xsl:when test="contains($controlField008-24,'s')"> Statistiques</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$controlField008-26='a'">donnée numérique</xsl:when>
 ...
 <xsl:when test="$controlField008-26='f'">Police</xsl:when>
 ...
 <xsl:when test="$controlField008-26='j'">Ressource en ligne</xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$controlField008-33='0'">Ikke skjÃ¸nnlitteratur</xsl:when>
 <xsl:when test="$controlField008-33='l'">LÃ¦rebok, brevkurs</xsl:when>
 <xsl:when test="$controlField008-33='1'">SkjÃ¸nnlitteratur</xsl:when>
 ...
 <xsl:if test="contains($controlField008-30-31,'b')">Biographe</xsl:if>
 <xsl:if test="contains($controlField008-30-31,'c')">Samtaler og diskusjoner</xsl:if>
 <xsl:if test="contains($controlField008-30-31,'d')">Drame</xsl:if>
 <xsl:if test="contains($controlField008-30-31,'e')">Essais</xsl:if>
 ...
 <xsl:if test="contains($controlField008-30-31,'r')">FremfÃ¸ring av alle typer ikke-musikalske produksjoner</xsl:if>
...
,1)='q']">
 ...
 <xsl:when test="$controlField008-22='b'">BilledbÃ¸ker for voksne;</xsl:when>
 <xsl:when test="$controlField008-22='j'">Barn og ungdom;</xsl:when>
 <xsl:when test="$controlField008-22='k'">BilledbÃ¸ker;</xsl:when>
 ...
 <xsl:when test="$controlField008-22='v'">BilledbÃ¸ker for barn i alderen til og med 5 Ã¥r;</xsl:when>
 <xsl:when test="$controlField008-22='w'">BilledbÃ¸ker for elever pÃ¥ 1. til 3. klassetrinn;</xsl:when>
 <xsl:when test="$controlField008-22='x'">BilledbÃ¸ker for elever pÃ¥ 4. og 5. klassetrinn;</xsl:when>
 <xsl:when test="$controlField008-22='y'">BilledbÃ¸ker for elever pÃ¥ 6. og 7. klassetrinn;</xsl:when>
 <xsl:when test="$controlField008-22='z'">BilledbÃ¸ker for elever pÃ¥ ungdomstrinnet;</xsl:when>
 <xsl:when test="$controlField008-22='f'">Specialisé;</xsl:when>
...
<span class="results_summary">
 ...
 <xsl:choose>
 <xsl:when test="count(key('item-by-status', 'available'))=0 and count(key('item-by-status', 'reference'))=0">Pas d'exemplaires disponible </xsl:when>
